  ...
  >
    <TransitionGroup name="slide-left">
      <div
        ...
        :class="[
          {
            'is-active bg-primary dark:bg-accent': tab.key === active,
          ...
          <div class="relative flex size-full items-center">
            ...
            >
              ...
              <X
                ...
                class="size-3 cursor-pointer rounded-full stroke-accent-foreground/80 transition-all group-[.is-active]:stroke-primary-foreground/90 group-[.is-active]:text-primary-foreground hover:bg-accent hover:stroke-accent-foreground group-[.is-active]:dark:stroke-accent-foreground group-[.is-active]:dark:text-accent-foreground"
                @click.stop="() => emit('close', tab.key)"
              />
              <Pin
                v-show="tab.affixTab && tabsView.length > 1 && tab.closable"
                class="mt-px size-3.5 cursor-pointer rounded-full transition-all group-[.is-active]:text-primary-foreground hover:bg-accent hover:stroke-accent-foreground group-[.is-active]:dark:text-accent-foreground"
            ...
            <!-- tab-item-main -->
            <div
              class="mx-3 mr-4 flex h-full items-center overflow-hidden rounded-tl-[5px] rounded-tr-[5px] pr-3 text-accent-foreground transition-all duration-300 group-[.is-active]:text-primary-foreground group-[.is-active]:dark:text-accent-foreground"
            >
              <VbenIcon
                v-if="showIcon"
                :icon="tab.icon"
